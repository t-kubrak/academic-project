...
$title = "Gift Goals - Newest Products Added";
require "header.php";

$productQuery = "SELECT productID, productName, imageURL FROM products order by pDateAdded DESC, productName ASC LIMIT 12 ";
...
<div class"row">
	<div class="col-md-12">
		<div class="row">
			<div class="col-md-12">
            <h2 class="text-center">Most Recent Additions</h2><hr>
            </div>
		</div>
		<div class="row">
<?php
